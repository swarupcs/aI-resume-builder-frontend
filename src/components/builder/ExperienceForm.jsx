...
const ExperienceForm = ({ data, onChange }) => {
  ...
  const generateDescription = async (index) => {
    ...
    const enhanced = `• Led cross-functional initiatives at ${experience.company} as ${experience.position}, driving measurable improvements in team productivity
• Collaborated with stakeholders to identify and implement process optimizations, resulting in enhanced operational efficiency
• Mentored junior team members and contributed to a culture of continuous learning and innovation`;
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="flex items-center gap-2 text-lg font-semibold text-foreground">Professional Experience</h3>
